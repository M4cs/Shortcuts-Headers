...
@class WFAction, WFLibraryRunCoordinator, WFWorkflow, WFWorkflowControllerState;
@protocol WFUserInterface;

@protocol WFLibraryRunCoordinatorDelegate <NSObject>
- (id <WFUserInterface>)runCoordinator:(WFLibraryRunCoordinator *)arg1 userInterfaceForWorkflow:(WFWorkflow *)arg2;

...
@class NSString, UIWindow, WFRootViewController, WFRunWorkflowAppIntentHandler, WFTutorialProgressStore;
...
@interface WFAppDelegate : UIResponder <UNUserNotificationCenterDelegate, UIApplicationDelegate>
{
    ...
    WFRunWorkflowAppIntentHandler *_intentHandler;
}

@property(retain, nonatomic) WFRunWorkflowAppIntentHandler *intentHandler; // @synthesize intentHandler=_intentHandler;
